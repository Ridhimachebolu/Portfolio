          ...
          <div className="w-full grid grid-cols-2 gap-4">
            {buttonTitles.map((item, index) => (
              <Link href={item.link} key={index} target="_blank">
                <div
                  className={`flex items-center justify-between space-x-2 bg-[#1e1e1e] text-gray-200 px-4 rounded-lg shadow-md transition duration-300 text-sm cursor-pointer font-normal${
                    hoveredIndex !== null && hoveredIndex !== index
                      ? "filter brightness-50"
                      : "hover:brightness-125"
                  } h-14`}
                  onMouseEnter={() => setHoveredIndex(index)} // Hover event
                  onMouseLeave={() => setHoveredIndex(null)} // Mouse leave event
                >
